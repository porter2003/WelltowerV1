...
import { createTask, toggleTask, updateTask, deleteTask } from '@/app/(app)/deals/actions';
import type { Task, DealStage, TaskPriority } from '@/lib/types';
...
export function TaskStageSection({ stage, tasks, dealId }: Props) {
